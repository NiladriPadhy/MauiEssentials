...
| MVVM application shell (ViewModels, async state, Shell or NavigationPage host) | Plugin.Maui.MVVMExpress | https://www.nuget.org/packages/Plugin.Maui.MVVMExpress | https://github.com/nuvyntralabs/Plugin.Maui.MVVMExpress |
